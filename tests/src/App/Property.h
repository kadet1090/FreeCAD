...
class CopyProperty: public ::testing::Test
{
protected:
    static void SetUpTestSuite()
    {
    ...
    void assertCopiedProperty(App::Property* property, App::DocumentObject* target);

    void testCopyProperty(App::DocumentObject* target);
