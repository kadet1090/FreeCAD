...
const App::PropertyQuantityConstraint::Constraints quantityRange = { 2 * Precision::Confusion(), num_float::max(), 0.1 };
const App::PropertyQuantityConstraint::Constraints quantityRangeZero = { 0.0, num_float::max(), 0.1 };
