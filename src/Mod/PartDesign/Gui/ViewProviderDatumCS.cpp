...
const App::PropertyFloatConstraint::Constraints ZoomConstraint = {0.0, num_double::max(), 0.2};
const App::PropertyIntegerConstraint::Constraints FontConstraint = {1, num_int::max(), 1};
