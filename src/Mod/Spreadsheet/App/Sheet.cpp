...
Property* Sheet::setFloatProperty(CellAddress key, double value)
{
    ...
    if (!prop || !prop->is<PropertyFloat>()) {
        ...
        floatProp = freecad_dynamic_cast<PropertyFloat>(addDynamicProperty(
            "App::PropertyFloat",
            name.c_str(),
            nullptr,
            nullptr,
...
Property* Sheet::setStringProperty(CellAddress key, const std::string& value)
{
    ...
    if (!stringProp) {
        ...
        stringProp = freecad_dynamic_cast<PropertyString>(addDynamicProperty(
            "App::PropertyString",
            name.c_str(),
            nullptr,
            nullptr,
...
Property* Sheet::setObjectProperty(CellAddress key, Py::Object object)
{
    ...
    if (!pyProp) {
        ...
        pyProp = freecad_dynamic_cast<PropertyPythonObject>(addDynamicProperty(
