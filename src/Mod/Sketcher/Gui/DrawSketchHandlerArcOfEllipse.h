...
public:
    ...
    void mouseMove(Base::Vector2d onSketchPos) override
    {
        if (Mode == STATUS_SEEK_First) {
            ...
            for (int i = 0; i < 16; i++) {
                double angle = i * Base::numbers::pi / 16.0;
            ...
            if (showCursorCoords()) {
                ...
                std::string aString = lengthToDisplayFormat(a, 1);
                std::string bString = lengthToDisplayFormat(b, 1);
                std::string angleString = angleToDisplayFormat(Base::toDegrees(arcAngle), 1);
    ...
    bool releaseButton(Base::Vector2d onSketchPos) override
    {
        ...
        if (Mode == STATUS_Close) {
            ...
            if (a > b) {
                ...
                endAngle += Base::numbers::pi / 2;
                startAngle += Base::numbers::pi / 2;
            }
