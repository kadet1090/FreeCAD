        ...
        if (state() == SelectMode::SeekSecond) {
            ...
            if (constructionMethod() == DrawSketchHandlerArcSlot::ConstructionMethod::ArcSlot) {
                ...
                addArcToShapeGeometry(
                    ...
                    angleReversed ? endAngle : startAngle + nm::pi,
                    angleReversed ? endAngle + nm::pi : startAngle + 2 * nm::pi,
                    r,
                    isConstructionMode()
                );
                ...
                addArcToShapeGeometry(
                    toVector3d(endPoint),
                    angleReversed ? startAngle + nm::pi : endAngle,
                    angleReversed ? startAngle + 2 * nm::pi : nm::pi + endAngle,
                    r,
                    isConstructionMode()
                );
    ...
    switch (handler->state()) {
        ...
        case SelectMode::SeekThird: {
            if (onViewParameters[OnViewParameter::Fifth]->isSet) {
                double arcAngle = Base::toRadians(onViewParameters[OnViewParameter::Fifth]->getValue());
