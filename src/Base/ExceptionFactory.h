...
public:
    ...
    virtual void raiseExceptionByType(const ExcData&) const = 0;
};
...
public:
    ...
    void raiseExceptionByType(const ExcData& data) const;
...
public:
    ...
    void raiseExceptionByType(const ExcData& data) const override
    {
