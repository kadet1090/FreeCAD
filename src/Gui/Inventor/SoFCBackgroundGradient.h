...
protected:
    ...
    QScopedPointer<QOpenGLTexture> noiseTex {};  // interleaved white noise texture with which the
                                                 // background texture is mixed

    QImage bgImage {};
    inline static QImage noiseImage {};

    inline static constexpr QSize bgTex_size {1280, 720};  // Coin3D may report incorrect values of
 ...
 * \param img
 * The creators of Call of Duty: Advanced Warfare recommend using interleaved gradient noise,
possessing properties from both dithering and random approaches. It has rich range of values like
random noise, but at the same time it produces temporally coherent results. This function creates
interleaved white noise invisible to the naked eye, but making big areas of the same color pleasant
to the eyes with spatial coherency.
 */
