...
std::string ProgramInformation::getValueOrEmpty(const Config& map,
...
void ProgramInformation::getVerboseCommonInfo(std::stringstream& str, const Config& mConfig)
{
...
void ProgramInformation::getVersionInformation(const Config& mConfig, std::stringstream& str)
{
...
void ProgramInformation::getBuildInformation(const Config& mConfig, std::stringstream& str)
{
...
void ProgramInformation::getIfcInfo(std::stringstream& str)
{
    try {
        ...
        if (!module.isNull() && module.hasAttr("version")) {
            ...
            std::string ver_str = static_cast<std::string>(version);
...
void ProgramInformation::getVerboseAddOnsInfo(std::stringstream& str, const Config& mConfig)
{
